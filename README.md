...
This is an implementation of the Kubernetes Container Runtime Interface (CRI)
...
Note that kpod and its container management and debugging commands have moved
to a separate repository, located [here](https://github.com/containers/podman).
...
requests on the GitHub repo. This will be the best place to discuss design and implementation.
